...
function center(out_vec2, bb2) {
    out_vec2[0] = (bb2[0] + bb2[1]) * 0.5;
    out_vec2[1] = (bb2[3] + bb2[2]) * 0.5;
 ...
 * @return {Boolean}
 */
function isVec2Inside(bb2, vec2) {
    return bb2[0] < vec2[0] && bb2[2] > vec2[0] && bb2[1] < vec2[1] && bb2[3] > vec2[1];
}
/**
 * @return {Boolean}
 */
function isBB2Inside(bb2, bb2_2) {
    return bb2[0] <= bb2_2[0] &&
        bb2[1] <= bb2_2[1] &&
        bb2_2[2] <= bb2[2] &&
        bb2_2[3] <= bb2[3];
}
 ...
 * @returns {Number}
 */
function perimeter(bb2) {
    return (bb2[2] - bb2[0]) * 2 + (bb2[3] - bb2[1]) * 2 ;
}
