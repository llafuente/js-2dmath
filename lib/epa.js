/**
* @see http://www.codezealot.org/archives/180
*/
...
// console.log("furthestMinkowski in", Polygon.toString(A), Polygon.toString(B), Vec2.toString(d));
    var a, b;
...
// console.log("support a/b", Vec2.toString(a), Vec2.toString(b));
...
function EPA(A, B, simplex) {
    ...
    while (true) {
        ...
        p = furthestMinkowski(A, B, e.normal);
