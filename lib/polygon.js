...
function furthestMinkowski(out_vec2, poly_a, poly_b, vec2_dir) {
    // console.log("furthestMinkowski in", Polygon.toString(poly_a), Polygon.toString(poly_b), Vec2.toString(vec2_dir));
    ...
    // console.log("support a/b", Vec2.toString(fm_a), Vec2.toString(fm_b));
